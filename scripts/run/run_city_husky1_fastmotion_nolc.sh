#!/bin/bash
# Run City Husky1 with FAST MOTION optimized settings WITHOUT LOOP CLOSURE
...
OUTPUT_PREFIX="city_husky1_fastmotion_nolc"

echo "=========================================="
echo "Running City Husky1 - FAST MOTION + NO LC"
...
./src/ORB_SLAM3/Examples/RGB-D/rgbd_airsim \
  ...
  /workspace/datasets/city/Husky1_RGBD_FastMotion_NoLC.yaml \
