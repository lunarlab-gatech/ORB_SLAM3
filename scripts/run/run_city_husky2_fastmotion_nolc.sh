#!/bin/bash
# Run City Husky2 with FAST MOTION optimized settings WITHOUT LOOP CLOSURE
...
OUTPUT_PREFIX="city_husky2_fastmotion_nolc"

echo "=========================================="
echo "Running City Husky2 - FAST MOTION + NO LC"
...
./src/ORB_SLAM3/Examples/RGB-D/rgbd_airsim \
  ...
  /workspace/datasets/city/Husky2_RGBD_FastMotion_NoLC.yaml \
