...
echo "========================================="
echo "Drone1 RGB-D Scale Focus - NO LOOP CLOSURE (TRIMMED)"
echo "========================================="
echo ""
...
echo "Setting up trimmed timestamps (7.0s to 1025.50s)..."
cp "$DATASET_DIR/timestamps.txt" "$DATASET_DIR/timestamps_backup.txt" 2>/dev/null
cp "$DATASET_DIR/timestamps_drone1_trimmed.txt" "$DATASET_DIR/timestamps.txt"
...
echo "Output: drone1_nolc_scalefocus_trimmed.log"
echo ""
...
./src/ORB_SLAM3/Examples/RGB-D/rgbd_airsim \
  ...
  drone1_nolc_traj
" 2>&1 | tee drone1_nolc_scalefocus_trimmed.log
...
mv "$DATASET_DIR/timestamps_backup.txt" "$DATASET_DIR/timestamps.txt" 2>/dev/null
