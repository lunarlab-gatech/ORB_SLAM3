...
echo "========================================="
echo "Husky1 RGB-D Scale Focus - NO LOOP CLOSURE"
echo "========================================="
echo ""

DATASET_DIR="/media/sgarimella34/hercules-collect/raw_data_hercules/ausenv_roadseq_2ugvuav/Husky1"
CONFIG_FILE="/media/sgarimella34/hercules-collect/raw_data_hercules/ausenv_roadseq_2ugvuav/Husky1_RGBD_ScaleFocus_NoLC.yaml"
...
./src/ORB_SLAM3/Examples/RGB-D/rgbd_airsim \
  ...
  /workspace/datasets/raw_data_hercules/ausenv_roadseq_2ugvuav/Husky1_RGBD_ScaleFocus_NoLC.yaml \
  ...
  husky1_nolc_traj
" 2>&1 | tee husky1_nolc_scalefocus.log

# Save results
if [ -f "CameraTrajectory.txt" ]; then
    echo ""
    echo "Saving results..."
    cp CameraTrajectory.txt husky1_nolc_scalefocus_result.txt
    cp KeyFrameTrajectory.txt husky1_nolc_scalefocus_kf_traj.txt
    ...
    python3 "$(dirname "$0")/../analyze/compare_trajectory_simple.py" \
        ...
        husky1_nolc_scalefocus_result.txt

    mv trajectory_comparison.png husky1_nolc_trajectory_comparison.png
fi
