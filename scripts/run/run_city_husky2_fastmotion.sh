#!/bin/bash
# Run City Husky2 with FAST MOTION optimized settings WITH LOOP CLOSURE
...
OUTPUT_PREFIX="city_husky2_fastmotion_lc"

echo "=========================================="
echo "Running City Husky2 - FAST MOTION + LC"
...
./src/ORB_SLAM3/Examples/RGB-D/rgbd_airsim \
  ...
  /workspace/datasets/city/Husky2_RGBD_FastMotion.yaml \
