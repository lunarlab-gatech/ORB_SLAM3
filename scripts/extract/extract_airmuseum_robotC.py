#!/usr/bin/env python3
"""
Extract AirMuseum Scenario5 stereo+GT data for robotC into the flat-file
format this workspace's ORB-SLAM3 RGB-D loader expects (timestamp-named PNGs +
timestamps.txt + TUM-format ground truth). Mono-Depth mode only -- no IMU needed.

Adapted from extract_airmuseum_data.py (drone, Stereo-Inertial pass) with
ROBOT_NAME switched to "robotC" and the IMU-extraction section dropped.
"""
import numpy as np
...
# ==================================== Export (images + GT only; no IMU needed) ====================================
OUT_DIR.mkdir(parents=True, exist_ok=True)
left_out = OUT_DIR / "rgb_stereo_left"
print(f"=== Writing rectified left images to {left_out} ===")
...
# ==================================== Config constants ====================================
print("\n" + "=" * 70)
print("CONFIG CONSTANTS (for RGB-D yaml)")
print("=" * 70)
